  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        ...
        // Pinned outside the scroll view so the primary action is always
        // reachable without scrolling, regardless of how tall the
        // exercise card above gets (a real gap on gym-equipment days,
        // whose cards carry a target-muscle line and two callouts the
        // bodyweight-only cards don't).
        SafeArea(
          top: false,
          child: Padding(
