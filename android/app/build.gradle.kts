...
android {
    ...
    defaultConfig {
        ...
        applicationId = "com.fitnesscompanion.fitness_companion"
        // You can update the following values to match your application needs.
        // For more information, see: https://flutter.dev/to/review-gradle-config.
        // minSdk 26 (not the Flutter default) because Health Connect —
        // the `health` plugin's Android backend — requires API 26+.
        minSdk = 26
